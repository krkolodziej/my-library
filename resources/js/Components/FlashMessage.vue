<template>
    ...
    >
        <div v-if="show" class="fixed top-4 right-4 max-w-sm w-full bg-white shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden z-50">
            <div class="p-4">
...
const checkFlashMessages = () => {
    if (page.props.flash?.success) {
        ...
        showMessage(page.props.flash.info, 'info')
    }
}
...
watch(() => page.props.flash, checkFlashMessages, { deep: true })
